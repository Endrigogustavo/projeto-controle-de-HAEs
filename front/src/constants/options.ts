export const COURSE_OPTIONS = [
  { value: "Análise e Desenvolvimento de Sistemas AMS", label: "Análise e Desenvolvimento de Sistemas AMS" },
  ...
  { value: "Desenvolvimento de Produtos Plásticos", label: "Desenvolvimento de Produtos Plásticos" },
  { value: "Desenvolvimento de Software Multiplataforma", label: "Desenvolvimento de Software Multiplataforma" },
